                        ...
                        <div class="japan-item">
                            <div class="swiper-wrapper">            
                                    ...
                                    <?php 
                                        ...
                                        $arr = aj_get("select id, model_id, model_name, marka_name, marka_id, color, mileage, eng_v, kpp, avg_price, year, images from main where marka_name='toyota' group by model_id order by model_name limit 250");
